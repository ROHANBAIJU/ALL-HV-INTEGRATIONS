...
android {
    namespace = "com.example.hyperkycsample"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.testhyperkyccompose"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    //implementation("co.hyperverge:hvnfc-sdk:2.1.1")
    implementation("co.hyperverge:hyperkyc:2.0.0"){
